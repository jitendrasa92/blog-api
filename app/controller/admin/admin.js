...
exports.forgotOtpVerify = async (req, res) => {
    ...
    if (!params.forgotToken) {
        response.message = adminMessages.admin.tokenNotProvided;
    } else {
        try {
    ...
    if (!params.forgotToken) {
        ...
        try {
            ...
            if (finaldata) {
                ...
                await Admin.findOneAndUpdate({ _id: finaldata.userId }, userUpdate);
                response.message = adminMessages.admin.changePasswordSuccess;
                response.status = true;
            } else {
                response.message = adminMessages.admin.tokenExpired;
            }
